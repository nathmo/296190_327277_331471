...
the picture are all in a given folder and in .png ("../dataset/praline_clean/MiscObjects") and have transparent background.
...
x1000px)
"""
path = ("../dataset/praline_clean/Tentation_noir")
